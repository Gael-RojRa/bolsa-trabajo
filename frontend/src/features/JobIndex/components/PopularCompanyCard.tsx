...
const PopularCompanyCard = () => {
  ...
  return (
    <IonCard className='popular-company-card'>
      <IonCardHeader className='popular-company-card__header'>
        <div className="logo-container">
          <img className='logo' src="https://www.svgrepo.com/show/303108/google-icon-logo.svg" alt="logo" width="30" />
        </div>
      ...
      <IonCardContent className='popular-company-card__job'>
        ...
        <IonCardSubtitle className="job__info">$2500/m <span className='job__info--ubication'>Toronto, Canada</span></IonCardSubtitle>
      </IonCardContent>
